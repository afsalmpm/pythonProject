...
to_be_CSV = [
    ["BUY DATE", "SYMBOL", "BUY PRICE", "QUANTITY", "SELL PRICE", "SELL DATE", "TURN OVER", "REAL P&L", "BROKERAGE"]]
x = " "
...
while x != "e":
    ...
    # # Printing calculated details FINISHED

    # A list of list for the preparation of Exell or CSV file
    to_be_CSV.append([buy_date, symbol, buy_price, quantity, sell_price, sell_date, turn_over, Real_PnL.__round__(2),
                      totalBrokerage.__round__(2)])

    # print(to_be_CSV)
    x = " "
    print(" ")
    x = input(' Press "e" to exit or press "ENTER" to add more ')
