...
data66 = openpyxl.load_workbook("C:\\Users\\dell\\Desktop\\P&L for python.xlsx")["P&L writing"].cell(row=128, column=3).value
print(f"data7 is {data66}")
...
for i in test_list:
    row_start = 1
    for j in i:
        sh1.cell(row=column_start, column=row_start, value=j)
